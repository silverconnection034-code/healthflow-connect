  ...
  return (
    <div className="module-page">
      ...
      <Tabs defaultValue="active">
        ...
        <TabsContent value="active"><div className="data-table-wrapper">{active.length === 0 ? <EmptyState icon={Ambulance} title="No active trips" /> : renderTable(active)}</div></TabsContent>
